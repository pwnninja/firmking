...
form_handle.wan_l2tp_password.value = trim_string(form_handle.wan_l2tp_password.value);
...
if(form_handle.wan_l2tp_use_dynamic_carrier.value == "false" ) {
	...
	if (!is_ipv4_valid(form_handle.wan_l2tp_server.value) || form_handle.wan_l2tp_server.value=="0.0.0.0" || is_FF_IP(form_handle.wan_l2tp_server.value)) {
	...
	if(is_blank(form_handle.wan_l2tp_username.value)) {
		...
		form_handle.wan_l2tp_username.select();
		form_handle.wan_l2tp_username.focus();
		return false;
	}
	if (form_handle.second_wan_l2tp_password.value !== form_handle.wan_l2tp_password.value) {
		alert(sw("txtTwoPasswordsNotSame"));
		form_handle.wan_l2tp_password.select();
...
set_radio(form_handle.wan_l2tp_use_dynamic_carrier_radio, mode);
if(mode == "true") {
...
{
var form_handle = document.forms[0];
wan_l2tp_use_dynamic_carrier_selector(form_handle.wan_l2tp_use_dynamic_carrier.value);
}
function wz_prev()
{
...
<form id="wz_form_pg_5" name="wz_form_pg_5" action="http://<% getInfo("goformIpAddr"); %>/goform/formSetWAN_Wizard56" method="post">
...
<input type="hidden" id="wan_l2tp_use_dynamic_carrier" name="config.wan_l2tp_use_dynamic_carrier" value="<% getWizardInformation("l2tp_wan_ip_mode"); %>"/>
<div id="box_header">
		<h1><SCRIPT language=javascript type=text/javascript>ddw("txtSetUsernameAndPassword");</SCRIPT>(L2TP)</h1>
<p><SCRIPT language=javascript type=text/javascript>ddw("txtWizardWanStr18");</SCRIPT></p>
		...
		<tr>
			...
			<td class="l_tb" width="304">
				<input type=radio value="true" id="wan_l2tp_use_dynamic_carrier_radio_1" name="wan_l2tp_use_dynamic_carrier_radio" onclick="wan_l2tp_use_dynamic_carrier_selector(this.value)"><SCRIPT language=javascript type=text/javascript>ddw("txtDynamicIP");</SCRIPT>
				&nbsp;&nbsp;
				<input type=radio value="false" id="wan_l2tp_use_dynamic_carrier_radio_0"  name="wan_l2tp_use_dynamic_carrier_radio" onClick="wan_l2tp_use_dynamic_carrier_selector(this.value)"><SCRIPT language=javascript type=text/javascript>ddw("txtStaticIP");</SCRIPT>
		</td>
		</tr>
		<tr>
			<td class="r_tb"><strong>L2TP <SCRIPT language=javascript type=text/javascript>ddw("txtIPAddress");</SCRIPT> :</strong></td>
			<td class="l_tb">
				<input type=text id="wan_l2tp_ip_address" name="config.wan_l2tp_ip_address" size=32 maxlength=15 value="<% getWizardInformation("l2tpIp"); %>">
			</td>
		</tr>
		<tr>
			<td class="r_tb"><strong>L2TP <SCRIPT language=javascript type=text/javascript>ddw("txtSubnetMask");</SCRIPT> :</strong></td>
			<td class="l_tb">
				<input type=text id="wan_l2tp_subnet_mask" name="config.wan_l2tp_subnet_mask" size=32 maxlength=15 value="<% getWizardInformation("l2tpSubnet"); %>">
			</td>
		</tr>
		<tr>
			<td class="r_tb"><strong>L2TP <SCRIPT language=javascript type=text/javascript>ddw("txtGatewayIPAddress");</SCRIPT> :</strong></td>
			<td class="l_tb">
				<input type=text id="wan_l2tp_gateway"  name="config.wan_l2tp_gateway"  size=32 maxlength=15 value="<% getWizardInformation("l2tp-wan-gateway-rom"); %>">
			</td>
		</tr>
		<tr>
			<td class="r_tb"><strong>L2TP<SCRIPT language=javascript type=text/javascript>ddw("txtServerIP");</SCRIPT><br><SCRIPT language=javascript type=text/javascript>ddw("txtServerIPSameAsGateway");</SCRIPT>&nbsp;:</strong></td>
			<td class="l_tb">
				<input type=text id="wan_l2tp_server" name="config.wan_l2tp_server" size=32 maxlength=15 value="<% getWizardInformation("l2tpServerIp"); %>">
			</td>
		</tr>
		<tr>
			<td class="r_tb"><strong><SCRIPT language=javascript type=text/javascript>ddw("txtUserName");</SCRIPT>:</strong></td>
			<td class="l_tb">
				<input type=text id="wan_l2tp_username" name="config.wan_l2tp_username"  size=32 maxlength=63 value="<% getWizardInformation("l2tpUserName"); %>">
			</td>
		</tr>
		<tr>
			<td class="r_tb"><strong><SCRIPT language=javascript type=text/javascript>ddw("txtPassword");</SCRIPT> :</strong></td>
			<td class="l_tb">
				<input type=password id="wan_l2tp_password" name="config.wan_l2tp_password" onfocus="select();" size=32 maxlength=63 value="<% getWizardInformation("l2tpPassword"); %>">
			</td>
		</tr>
		<tr>
			<td class="r_tb"><strong><SCRIPT language=javascript type=text/javascript>ddw("txtVerifyPassword");</SCRIPT>:</strong></td>
			<td class="l_tb">
				<input type=password id="second_wan_l2tp_password" onfocus="select();" size=32 maxlength=63 value="<% getWizardInformation("l2tpPassword"); %>">
			</td>
		</tr>
		</table>
		<br>
