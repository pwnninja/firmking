		...
		{	  
			...
			if (__AjaxReq.status == 200)
			{
				...
				if (status=='0')
				{
					...
					self.location.href="Wizard_Tp_WanDetect.asp?t="+new Date().getTime()+"&type="+status;
...
{
	send_wan_type_request("/Basic/ajax_wan_disconnect.asp?r="+generate_random_str());
		
}
function page_load() 
{
	//setInterval("decetive_wan_type()", 3000);
	decetive_wan_type();
...
function init()
{
var DOC_Title= sw("txtTitle")+" : "+sw("txtWizardEasyStepWanIsCutDown");
document.title = DOC_Title;	
get_by_id("Login").value = sw("txtWizardEasyStepNotNeedInternet");		
}
		...
		<table id="table_shell" cellspacing="0" summary=""><col span="1"/>
			...
			<div class="section">
				<div class="section_head"> 
					<h5><SCRIPT >ddw("txtWizardEasyStepWanIsCutDown");</SCRIPT></h5>
					<br><br>
					<p align="center"><SCRIPT >ddw("txtWizardEasyStepMakeSure");</SCRIPT><br><SCRIPT >ddw("txtWizardEasyStepManualCT");</SCRIPT></p>
					<br>
					<p align="center"> <input class="button_submit_padleft" type="submit" id="Login" name="Login" value="" onclick="page_submit();"></p>
					<br>
				</div>
			</div> <!-- section -->
									<!-- InstanceEndEditable -->
