...
if(wifisc_hidden == 1)
{
	document.getElementById("advance_help").innerHTML = "";
}
else
{
	document.getElementById("advance_help").innerHTML = sw("xtAdvanceHp01_2");
}*/
}
...
<SCRIPT >ddw("txtAdvanceHp01");</SCRIPT><!--<span id="advance_help"></span><SCRIPT >ddw("txtAdvanceHp01_3");</SCRIPT>-->

<SCRIPT >ddw("txtRoute_help");</SCRIPT>
<SCRIPT >ddw("txtAdvanceHp_end");</SCRIPT>
</div>
